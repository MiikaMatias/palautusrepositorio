...
class TestIntJoukko(unittest.TestCase):
    ...
    def toimii_kasvatuksen_jalkeen(self, joukko):
        ...
        self.assertTrue(joukko.elementti_loytyy_lukujonosta(11))
        joukko.poista(11)
        self.assertFalse(joukko.elementti_loytyy_lukujonosta(11))
    ...
    def test_vain_lisatyt_luvut_loytyvat(self):
        self.assertTrue(self.joukko.elementti_loytyy_lukujonosta(10))
        self.assertFalse(self.joukko.elementti_loytyy_lukujonosta(5))
        self.assertTrue(self.joukko.elementti_loytyy_lukujonosta(3))

    def test_poistettu_ei_ole_enaa_joukossa(self):
        self.joukko.poista(3)
        self.assertFalse(self.joukko.elementti_loytyy_lukujonosta(3))
    ...
    def test_yhdiste(self):
        ...
        tulos = IntJoukko.yhdiste_erotus(eka, toka, True)
    ...
    def test_erotus(self):
        ...
        tulos = IntJoukko.yhdiste_erotus(eka, toka, False)
        vastauksen_luvut = tulos.to_int_list()
